setwd("C:/Users/greg.bolla/Desktop/Personal/Data Science Competitions/March Madness 2018")
library(lattice)
library(e1071)
library(dplyr)
library(reshape)
...
reg.season.compact <- read.csv("data/RegularSeasonCompactResults_Prelim2018.csv")
reg.season.detailed <- read.csv("data/RegularSeasonDetailedResults_Prelim2018.csv")
...
massey.ordinals.2018 <- read.csv("data/MasseyOrdinals_Prelim2018.csv")
massey.ordinals.historical <- read.csv("data/MasseyOrdinals.csv")
massey.ordinals.historical <- rbind(massey.ordinals.2018, massey.ordinals.historical)
...
cat("================================", "\n", "Massey Ordinals 2018 Data","\n","================================")
head(massey.ordinals.2018, n = 20)
...
detailed.seasons <- c(2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018) 
...
#for (team in 1:15) {
  ...
  for (year in 1:length(detailed.seasons)) {
    ...
    if (detailed.seasons[year] == 2018) {last_day <- 77} else {last_day <- 154}
